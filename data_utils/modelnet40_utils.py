...
from utils.common_utils import pc_normalize, farthest_point_sample
...
if __name__ == "__main__":
    ...
    pts = TEST_DATASET[101]
    def get_key_from_value(d, target_value):
        for key, value in d.items():
            if value == target_value:
                return key
        return None
    np.save(f'{get_key_from_value(TEST_DATASET.classes, pts[1])}_no_color.npy', pts[0][:, [0, 2, 1]])